...
class BardAPI {
  ...
  async getBardResponse(input_text) {
    ...
    const bard_answer = {
      content: parsed_answer[4]?.[0]?.[1]?.[0] || null,
      conversation_id: parsed_answer[1]?.[0] || null,
      response_id: parsed_answer[1]?.[1] || null,
      factualityQueries: parsed_answer[3] || [],
      textQuery: parsed_answer[2]?.[0] || '',
      choices: Array.isArray(parsed_answer[4])
        ? parsed_answer[4].map((i) => ({ id: i[0], content: i[1] }))
        : [],
    };
